...
namespace ProjectPaardRacing
{
    public partial class frmmarkt : Form
    {
        ...
        private void aankooppaard(int paardprijs,String paardnaam)
        {
            ...
            if (Settings1.Default.Paard1.Equals("geen") && paardprijs < Settings1.Default.Saldo)
            {
                Settings1.Default.Paard1 = paardnaam;
                Settings1.Default.Saldo = Settings1.Default.Saldo - paardprijs;

            }
            else if (Settings1.Default.Paard2.Equals("geen") && !(Settings1.Default.Paard1.Equals(paardnaam)) && paardprijs < Settings1.Default.Saldo)
            {
                Settings1.Default.Paard2 = paardnaam;
                Settings1.Default.Saldo = Settings1.Default.Saldo - paardprijs;
            }
            else if (Settings1.Default.Paard3.Equals("geen") && !(Settings1.Default.Paard1.Equals(paardnaam)) && !(Settings1.Default.Paard2.Equals(paardnaam)) && paardprijs < Settings1.Default.Saldo)
            {
